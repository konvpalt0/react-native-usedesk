...
RCT_EXTERN_METHOD(initChat:(NSString *)companyID url: (NSString *)url port: (NSString *)port api_token: (NSString *)api_token email: (NSString *)email phone: (NSString *)phone name: (NSString *)name nameChat: (NSString *)nameChat signature: (NSString *)signature);
