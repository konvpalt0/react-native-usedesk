...
public class RNUsedeskModule extends ReactContextBaseJavaModule {
    ...
    @ReactMethod
    public void initChat(String companyID, String url, String port, String api_token, String email, String phone, String name, String nameChat, String signature) {
...
//        UsedeskChatConfiguration usedeskChatConfiguration = new UsedeskChatConfiguration(companyID, email, "https://" + url + ":" + port, url, name, Long.valueOf(phone), null);
        UsedeskChatConfiguration usedeskChatConfiguration = new UsedeskChatConfiguration("https://" + url + ":" + port, url, "https://mango.usedesk.ru/uapi/v1/", companyID, signature, email, name, "", Long.valueOf(phone));
